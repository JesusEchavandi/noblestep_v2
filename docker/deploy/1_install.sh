...
echo "  ⚠️  Debes configurar la base de datos manualmente:"
echo "     sudo mysql"
echo "     CREATE DATABASE IF NOT EXISTS noblestep_db CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;"
echo "     CREATE USER IF NOT EXISTS 'noblestep'@'localhost' IDENTIFIED BY '<TU_PASSWORD_SEGURO>';"
echo "     GRANT ALL PRIVILEGES ON noblestep_db.* TO 'noblestep'@'localhost';"
echo "     FLUSH PRIVILEGES;"
echo "  Luego configura la variable de entorno NOBLESTEP_DB_CONNECTION en el systemd service."
